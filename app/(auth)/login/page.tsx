  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1a1a1e]">
      <div className="max-w-sm w-full space-y-8 p-8">
        ...
        <button
          onClick={handleLogin}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#393E46] rounded-xl bg-[#393E46] text-sm font-medium text-white hover:bg-[#434850] transition-colors"
        >
